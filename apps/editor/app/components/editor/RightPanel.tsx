...
export default function RightPanel({
  ...
  const renderPropertiesContent = () => {
    ...
    return (
      <>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  handleCommonPropertyChange("name", e.target.value)
                }
              />
            </div>
            <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <div>
                ...
                <Input
                  type="text"
                  value={formatTime(
                    (selectedScrubber.left + selectedScrubber.width) /
                      pixelsPerSecond
                  )}
                  onChange={(e) => {
                    ...
                    if (newEndTime !== null && newEndTime >= 0) {
                      ...
                      if (newEndTime > startTime) {
                        const newWidth =
                          (newEndTime - startTime) * pixelsPerSecond;
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    handleTextPropertyChange("textContent", e.target.value)
                  }
                  rows={3}
                />
              </div>
              <div>
                ...
                <Slider
                  ...
                  onValueChange={(value) =>
                    handleTextPropertyChange("fontSize", value[0])
                  }
                  min={8}
                  max={200}
                  step={1}
                ...
                <span className="text-sm text-gray-500">
                  {selectedScrubber.text?.fontSize || 16}px
                </span>
              </div>
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    handleTextPropertyChange("fontFamily", value)
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    handleTextPropertyChange("textAlign", value)
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    handleTextPropertyChange("fontWeight", value)
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Slider
                  ...
                  onValueChange={(value) =>
                    handleCommonPropertyChange("playbackSpeed", value[0])
                  }
                  min={0.25}
                  max={4}
                  step={0.25}
                />
                <span className="text-sm text-gray-500">
                  {selectedScrubber.playbackSpeed || 1}x
                </span>
              </div>
            </CardContent>
          </Card>
        ...
        <KeyframeEditor
          selectedScrubber={selectedScrubber}
  ...
  const handlePlayerPropertyChange = (
    property: string,
    value: string | number
  ) => {
    if (!selectedScrubber) return;
